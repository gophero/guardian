// Adopted from - https://github.com/rs/zerolog/blob/5391dd7c34c86c2a3b731cd3c3f1b252706e7925/log/log.go
...
var Logger = zerolog.New(os.Stderr).With().Caller().Timestamp().Logger().Level(zerolog.InfoLevel).Hook(tracingHook{})
